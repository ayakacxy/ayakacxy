...
## 专业技能
- 擅长编程，精通大语言模型使用辅助完成各种工作，擅长 prompt 工程
- 会使用主流的办公软件，熟练使用 LATEX，可以使用 LATEX 编写论文和 PPT
- 了解机器学习和深度学习，尤其是 NLP 领域方面的一些知识

## 联系方式
- **GitHub**: [ayakacxy](https://github.com/ayakacxy/ayakacxy)
- **邮箱**: [cxy20031013@mail.ustc.edu.cn](mailto:cxy20031013@mail.ustc.edu.cn)
